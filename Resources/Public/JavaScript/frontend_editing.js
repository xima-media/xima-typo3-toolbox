document.addEventListener('DOMContentLoaded', function() {
  ...
  elements.forEach(function(element) {
    ...
    editButton.title = TYPO3.lang['frontend-editing.label.menu'];
